...
def test_ecdh_derive_shared_secret():
    ...
    adeSecretKey = "23832cbef38641b8754a35f1f79bbcbc248e09ac93b01c2eaf12474f2ac406b6"
    adePublicKey = "04fd4ca9eb7954a03517ac8249e6070aa3112e582f596b10f0d45d757b56d5dc0395a7d207d06503a4d6ad6e2ad3a1fd8cc233c072c0dc0f32213deb712c32cbdf"
    ...
    adeSecret = derive_shared_secret(adeSecretKey, bobPublicKey)
    print("Ade secret: ", adeSecret.hex())
    bobSecret = derive_shared_secret(bobSecretKey, adePublicKey)
    print("Bob secret: ", bobSecret.hex())

    assert adeSecret == bobSecret, "Both parties should generate the same secret"
...
def test_ecdh_derive_shared_secret_random():
    ...
    adeSecretKey = SigningKey.generate(curve=NIST256p)
    ade = ECDH(curve=NIST256p)
    ade.load_private_key(adeSecretKey)
    adePublicKey = ade.get_public_key()
    ...
    # Each user derives the same shared secret, independantly, using the other's public key which is exchanged
    adeSecret = derive_shared_secret_from_key(adeSecretKey, bobPublicKey)
    print("Ade secret: ", adeSecret.hex())
    bobSecret = derive_shared_secret_from_key(bobSecretKey, adePublicKey)
    print("Bob secret: ", bobSecret.hex())
...
def test_ecdh_generate_key():
    ...
    adeKey = concat_kdf(adeSecret, alg, apu, apv, keydatalen)
    print("Ade key: ", adeKey.hex())
