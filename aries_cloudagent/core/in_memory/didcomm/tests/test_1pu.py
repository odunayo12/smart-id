...
def test_1pu_hex_example():
    ...
    adeEphemeralSecretKey = (
        "b5b1158f6fba847407853cdf4bfbcf120412e25918eb15d5a1e7fe04570f6907"
    )
    adeEphemeralPublicKey = "04bf4e51d403a9cdfcfa2fe38abf6229db33f59ac14395e92f5b353af213391484f017d3d336f4e03ca974285722641be48d98d5589104ab99abe702fb2bfa6fe2"
    ...
    adeKey = derive_sender_1pu(
        adeEphemeralSecretKey, adeSecretKey, bobPublicKey, alg, apu, apv, keydatalen
    )
    print("Ade 1PU key: ", adeKey.hex())
    bobKey = derive_receiver_1pu(
        adeEphemeralPublicKey, adePublicKey, bobSecretKey, alg, apu, apv, keydatalen
    )
...
def test_1pu_appendix_example():
    ...
    adeSecretKey = b64_to_bytes(d, urlsafe=True).hex()
    adePublicKey = (
    ...
    adeEphemeralSecretKey = b64_to_bytes(d, urlsafe=True).hex()
    adeEphemeralPublicKey = (
        b64_to_bytes(x, urlsafe=True) + b64_to_bytes(y, urlsafe=True)
    ).hex()
